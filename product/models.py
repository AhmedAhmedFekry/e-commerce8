...
def get_vendor():
    return Vendor.objects.get(id=1)
...
class Compare(models.Model):
    user = models.ForeignKey(User,
                             related_name="usercompare",
                             on_delete=models.CASCADE)
    product = models.ForeignKey(Product,
                                related_name="compareproduct",
                                on_delete=models.CASCADE)
    value = models.CharField(choices=COMPARE_CHOICES,
                             default="yes",
                             max_length=10)
